...
float Settings::MinDistanceFromNextCar = 200;
float Settings::MinDistanceFromStop = 100;
...
// M, CM, Feet, Inch
float Settings::DistanceUnitScales[5]{0.01, 1, 0.0328, 0.3937, 1/Scale};

// [Speed in px/s] * Scale * unitScale = Speed in Unit
// that means that [speed in cm/s] * unitScale = Speed in Unit
float Settings::VelocityUnitScales[5]{1, 0.036, 0.01, 0.022, 1/Scale};
...
float Settings::MaxSpeeds[3]{ConvertVelocity(KMH, PXS, 100.f), ConvertVelocity(KMH, PXS, 90.f), ConvertVelocity(KMH, PXS, 110.f)};
float Settings::MaxAcceleration[3]{ConvertVelocity(KMH, PXS, 4.5f), ConvertVelocity(KMH, PXS, 3.f), ConvertVelocity(KMH, PXS, 5.5f)};
float Settings::MinAcceleration[3]{ConvertVelocity(KMH, PXS, -8.5f), ConvertVelocity(KMH, PXS, -7.f), ConvertVelocity(KMH, PXS, -12.f)};